...
start "Genetic Central Server" "%EDITOR_CMD%" "%PROJECT%" -run=GeneticServer -NoUI -NoSound -NullRHI -NoShaderCompile -NoTextureStreaming -AllowCommandletRendering=false -nosplash -LogCmds="global warning, LogGeneticServer all"
